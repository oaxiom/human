...
transcript_types_dont_keep = set(['miRNA', 'snRNA', 'snoRNA', 'Mt_tRNA', 'Mt_rRNA', 'TEC', 'scRNA', 'scaRNA','vaultRNA',
    ...
    'non_stop_decay',
    'transcribed_unitary_pseudogene', 'rRNA_pseudogene', 'transcribed_unprocessed_pseudogene',
    'processed_pseudogene', 'transcribed_processed_pseudogene', 'pseudogene', 'translated_processed_pseudogene',
    'unprocessed_pseudogene', 'polymorphic_pseudogene',  'unitary_pseudogene', 'translated_unprocessed_pseudogene',
...
gl = gl.getColumns(['ensg', 'name', 'transcript_type'])
gl = gl.removeDuplicates('ensg')
gl.saveTSV('hg38_gencode_ensg_v%s.tsv' % version, key_order=['ensg', 'name'])
gl.save('hg38_gencode_ensg_v%s.glb' % version)
